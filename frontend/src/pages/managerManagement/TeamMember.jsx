             ...
             {teamMemberData.map((member, index) => (
               <tbody key={index}>
                 <tr>
                   ...
                   <td className={member.Status === "Active" ? "status-badge status-active" : "status-badge status-inactive" } style={{marginTop: 15}}> {member.Status} </td>
                   <td>
                     <button className='viewbtn' onClick={() => setViewModal(true)}>View</button>
                   </td>
                 </tr>
               </tbody>
             ))}
