...
import todaycalls from "../../assets/salesExecutive/Report/Todaycalls.png";
import transferdata from "../../assets/salesExecutive/Report/Transferdata.png";
    ...
    <div>
      <div id="report-container">
        <section id="report-data">
          ...
          <h1 className="table-head">Today Call Logs</h1>
            ...
            <tbody>
              {data.map((row, idx) => (
                <tr key={idx}>
                  ...
                  <td>
                    <button className="update-btn">{row.activity}</button>
                  </td>
                </tr>
              ))}
            </tbody>
