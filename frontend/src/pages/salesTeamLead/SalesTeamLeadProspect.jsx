...
function SalesTeamLeadProspect() {
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    // TODO: replace with API call / update logic
      ...
      <div className="leadprospectContainer">
        ...
        <div className="tableContainer">
          ...
          <tr>
            ...
            {data.map((item, index) => (
              <tr key={index}>
                <td><img src={dot} alt="" /></td>
                <td>{item.companyName}</td>
                <td>{item.clientName}</td>
                <td>{item.emailId}</td>
                <td>{item.contactNo}</td>
                <td>{item.reminderDate}</td>
                <td><button onClick={()=> setUpdateModal(true)}>Update</button></td>
                <td><button onClick={()=>setViewModal(true)}>View</button></td>
...
export default SalesTeamLeadProspect